...
namespace Error
{
	...
	ERROR_ENTRY(209,"Разные типы данных в одном выражении"),
	...
	ERROR_ENTRY(213,"Возвращаемый тип не соответствует типу функции"),
	...
	ERROR_ENTRY(606, "Ошибка в условной конструкции"), 
